...
public class CreateGameInputModelValidator : AbstractValidator<CreateGameInputModel>
{
    public CreateGameInputModelValidator()
    {
        Log.Information("Iniciando {ValidatorName}", nameof(CreateGameInputModelValidator));
