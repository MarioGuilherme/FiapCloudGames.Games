using FiapCloudGames.Games.API.Filters;
using FiapCloudGames.Games.API.Middlewares;
using FiapCloudGames.Games.Application;
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.NewRelicLogs(
        ...
        applicationName: "FiapCloudGames.Games")
    .CreateLogger();
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new()
    {
        Title = "API - Fiap Cloud Games - Games",
...
try
{
    ...
    FiapCloudGamesGamesDbContext context = services.GetRequiredService<FiapCloudGamesGamesDbContext>();
